...
def show_list():
    ...
    # Crée un lien YouTube en utilisant le nom du bouton
    youtube_link = f"https://www.youtube.com/results?search_query={button_name}"
    ...
    return render_template('index.html', title=title, liste_name=liste_name, button_names=button_names, selected_list=selected_list_with_links, youtube_link=youtube_link)
